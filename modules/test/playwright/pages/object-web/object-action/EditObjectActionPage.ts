...
export class EditObjectActionPage {
	...
	constructor(page: Page) {
		...
		this.userPreferredLanguage = page
			.frameLocator('iframe')
			.getByText(`Send email notifications in a guest user's preferred language.`)
	...
	async addNewAction(thenOption: string, whenOption: string, notificationTemplateName?: string) {
