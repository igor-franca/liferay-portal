...
public class NumericDDMFormFieldTemplateContextContributor
		...
		return HashMapBuilder.<String, Object>put(
			...
			() -> {
				if (localizedObjectField) {
					...
					Map<String, Object> localizedValues = jsonObject.toMap();
					...
					return _jsonFactory.createJSONObject(localizedValues);
				}
	...
	private String _getValue(String valueString) {
		String value = _htmlParser.extractText(valueString);
