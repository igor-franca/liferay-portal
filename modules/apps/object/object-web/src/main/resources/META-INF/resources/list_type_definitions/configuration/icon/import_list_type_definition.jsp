...
<div>
	...
	Map<String, Object> warningModalText = HashMapBuilder.<String, Object>put(
		"body", Arrays.asList(LanguageUtil.get(request, "there-is-a-picklist-with-the-same-external-reference-code-as-the-imported-one"), LanguageUtil.format(request, "before-importing-the-new-x-you-may-want-to-back-up-its-entries-to-prevent-data-loss", "picklist"), LanguageUtil.get(request, "do-you-want-to-proceed-with-the-import-process"))
	).put(
	...
	<react:component
		...
		props='<%=
			HashMapBuilder.<String, Object>put(
				...
				"JSONInputId", liferayPortletResponse.getNamespace() + "listTypeDefinitionJSON"
			).put(
				"nameMaxLength", ModelHintsConstants.TEXT_MAX_LENGTH
			).put(
				"portletNamespace", liferayPortletResponse.getNamespace()
			).put(
				"title", LanguageUtil.get(request, "import-picklist")
			).put(
