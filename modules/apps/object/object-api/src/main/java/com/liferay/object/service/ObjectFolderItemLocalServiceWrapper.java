...
public class ObjectFolderItemLocalServiceWrapper
	...
	public void deleteObjectFolderItemsByObjectDefinitionId(
		...
		_objectFolderItemLocalService.
			deleteObjectFolderItemsByObjectDefinitionId(objectDefinitionId);
	}

	@Override
	public void deleteObjectFolderItemsByObjectFolderId(long objectFolderId) {
		_objectFolderItemLocalService.deleteObjectFolderItemsByObjectFolderId(
			objectFolderId);
	}
	...
	public java.util.List<com.liferay.object.model.ObjectFolderItem>
		...
		return _objectFolderItemLocalService.
			fetchObjectFolderItemsByObjectDefinitionId(objectDefinitionId);
	}

	@Override
	public java.util.List<com.liferay.object.model.ObjectFolderItem>
		fetchObjectFolderItemsByObjectFolderId(long objectFolderId) {

		return _objectFolderItemLocalService.
			fetchObjectFolderItemsByObjectFolderId(objectFolderId);
	}
