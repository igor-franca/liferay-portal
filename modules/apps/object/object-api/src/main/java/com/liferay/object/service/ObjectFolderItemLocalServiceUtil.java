...
public class ObjectFolderItemLocalServiceUtil {
	...
	public static ObjectFolderItem addObjectFolderItem(
		...
		return getService().addObjectFolderItem(
			objectDefinitionId, objectFolderId, userId, positionX, positionY);
	}
	 ...
	 *
	 * @param objectFolderItemPK the primary key for the new object folder item
	 * @return the new object folder item
	 */
	public static ObjectFolderItem createObjectFolderItem(
		com.liferay.object.service.persistence.ObjectFolderItemPK
			objectFolderItemPK) {

		return getService().createObjectFolderItem(objectFolderItemPK);
	}
	 ...
	 * </p>
	 *
	 * @param objectFolderItemPK the primary key of the object folder item
	 * @return the object folder item that was removed
	...
	public static ObjectFolderItem deleteObjectFolderItem(
		...
		return getService().deleteObjectFolderItem(objectFolderItemPK);
	}

	public static void deleteObjectFolderItemsByObjectDefinitionId(
		long objectDefinitionId) {

		getService().deleteObjectFolderItemsByObjectDefinitionId(
			objectDefinitionId);
	}

	public static void deleteObjectFolderItemsByObjectFolderId(
		long objectFolderId) {

		getService().deleteObjectFolderItemsByObjectFolderId(objectFolderId);
	}
	...
	public static ObjectFolderItem fetchObjectFolderItem(
		...
		return getService().fetchObjectFolderItem(objectFolderItemPK);
	}
	...
	public static List<ObjectFolderItem>
		fetchObjectFolderItemsByObjectDefinitionId(long objectDefinitionId) {

		return getService().fetchObjectFolderItemsByObjectDefinitionId(
			objectDefinitionId);
	}

	public static List<ObjectFolderItem> fetchObjectFolderItemsByObjectFolderId(
		long objectFolderId) {

		return getService().fetchObjectFolderItemsByObjectFolderId(
			objectFolderId);
	}
	...
	public static ObjectFolderItem getObjectFolderItem(
		...
		return getService().getObjectFolderItem(objectFolderItemPK);
	}
	...
	public static void updateObjectFolderItem(
			long objectDefinitionId, long newObjectFolderId,
			long oldObjectFolderId)
		throws PortalException {

		getService().updateObjectFolderItem(
