...
public class ObjectFolderItem implements Serializable {
	...
	@Schema
	public Boolean getLinkedDefinition() {
		return linkedDefinition;
	}

	public void setLinkedDefinition(Boolean linkedDefinition) {
		this.linkedDefinition = linkedDefinition;
	}

	@JsonIgnore
	public void setLinkedDefinition(
		UnsafeSupplier<Boolean, Exception> linkedDefinitionUnsafeSupplier) {

		try {
			linkedDefinition = linkedDefinitionUnsafeSupplier.get();
		}
	...
	protected Boolean linkedDefinition;
