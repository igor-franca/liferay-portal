...
public class ObjectEntryVersionPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationCountByOEI_S;
	...
	/**
	 * Returns all the object entry versions where objectEntryId = &#63; and status = any &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>ObjectEntryVersionModelImpl</code>.
	 * </p>
	...
	@Override
	public List<ObjectEntryVersion> findByOEI_S(
		long objectEntryId, int[] statuses) {

		return findByOEI_S(
			objectEntryId, statuses, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null);
	}

	/**
	 * Returns a range of all the object entry versions where objectEntryId = &#63; and status = any &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>ObjectEntryVersionModelImpl</code>.
	 * </p>
	...
	@Override
	public List<ObjectEntryVersion> findByOEI_S(
		long objectEntryId, int[] statuses, int start, int end) {

		return findByOEI_S(objectEntryId, statuses, start, end, null);
	}

	/**
	 * Returns an ordered range of all the object entry versions where objectEntryId = &#63; and status = any &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>ObjectEntryVersionModelImpl</code>.
	 * </p>
	...
	public List<ObjectEntryVersion> findByOEI_S(
		...
		return findByOEI_S(
			objectEntryId, statuses, start, end, orderByComparator, true);
	}

	/**
	 * Returns an ordered range of all the object entry versions where objectEntryId = &#63; and status = &#63;, optionally using the finder cache.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>ObjectEntryVersionModelImpl</code>.
	 * </p>
	...
	public List<ObjectEntryVersion> findByOEI_S(
		...
		if (statuses.length == 1) {
			return findByOEI_S(
				objectEntryId, statuses[0], start, end, orderByComparator);
		}
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderArgs = new Object[] {
					objectEntryId, StringUtil.merge(statuses)
				};
			}
		}
		else if (useFinderCache) {
			finderArgs = new Object[] {
				objectEntryId, StringUtil.merge(statuses), start, end,
				orderByComparator
			};
		}
		...
		if (useFinderCache) {
			list = (List<ObjectEntryVersion>)finderCache.getResult(
				_finderPathWithPaginationFindByOEI_S, finderArgs, this);
			...
			if ((list != null) && !list.isEmpty()) {
				for (ObjectEntryVersion objectEntryVersion : list) {
					if ((objectEntryId !=
							objectEntryVersion.getObjectEntryId()) ||
						!ArrayUtil.contains(
							statuses, objectEntryVersion.getStatus())) {
		...
		if (list == null) {
			...
			if (statuses.length > 0) {
				...
				sb.append(_FINDER_COLUMN_OEI_S_STATUS_7);
			...
			try {
				...
				if (useFinderCache) {
					finderCache.putResult(
						_finderPathWithPaginationFindByOEI_S, finderArgs, list);
				}
			}
			catch (Exception exception) {
				throw processException(exception);
	...
	/**
	 * Returns the number of object entry versions where objectEntryId = &#63; and status = any &#63;.
	 *
	 * @param objectEntryId the object entry ID
	 * @param statuses the statuses
	 * @return the number of matching object entry versions
	 */
	@Override
	public int countByOEI_S(long objectEntryId, int[] statuses) {
		if (statuses == null) {
			statuses = new int[0];
		}
		else if (statuses.length > 1) {
		...
		Long count = (Long)finderCache.getResult(
			_finderPathWithPaginationCountByOEI_S, finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				finderCache.putResult(
					_finderPathWithPaginationCountByOEI_S, finderArgs, count);
			}
			catch (Exception exception) {
				throw processException(exception);
			}
	...
	private static final String _FINDER_COLUMN_OEI_S_STATUS_7 =
		"objectEntryVersion.status IN (";
	...
	public void activate() {
		...
		_finderPathWithPaginationCountByOEI_S = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByOEI_S",
			new String[] {Long.class.getName(), Integer.class.getName()},
			new String[] {"objectEntryId", "status"}, false);
