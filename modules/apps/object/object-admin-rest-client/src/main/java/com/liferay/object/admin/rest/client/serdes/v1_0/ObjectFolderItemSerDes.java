...
public class ObjectFolderItemSerDes {
	...
	public static String toJSON(ObjectFolderItem objectFolderItem) {
		...
		if (objectFolderItem.getLinkedDefinition() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(objectFolderItem.getLinkedDefinition());
		}
	...
	public static Map<String, String> toMap(ObjectFolderItem objectFolderItem) {
		...
		if (objectFolderItem.getLinkedDefinition() == null) {
			map.put("linkedDefinition", null);
		}
		else {
			map.put(
				"linkedDefinition",
				String.valueOf(objectFolderItem.getLinkedDefinition()));
		}
	...
	public static class ObjectFolderItemJSONParser
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "linkedDefinition")) {
				if (jsonParserFieldValue != null) {
					objectFolderItem.setLinkedDefinition(
