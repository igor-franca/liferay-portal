					...
					const versionSpecificationId = await saveSpecification(
					  ...
					  appVersion?.id,
						...
						if(versionSpecificationId != -1){
							dispatch({
								payload: {id: versionSpecificationId , value: appVersion.value },
								type: TYPES.UPDATE_APP_VERSION,
							  })
						}
						else{
							dispatch({
								payload: {id: appVersion?.id , value: appVersion.value},
								type: TYPES.UPDATE_APP_VERSION,
							  })
						}
					  ...
					  if(noteSpecificationId != -1){
						dispatch({
							payload: { id: noteSpecificationId, value: appNotes.value },
							type: TYPES.UPDATE_APP_NOTES,
						  })
					  }
					  else{
